...
<head>
  ...
  <meta charset="utf-8">
  <title>Početna - Hotel Vidović</title>
  ...
  <div id="page_wrapper">
                ...
                <div class="col-md-10 col-md-offset-1 text-center">
                  <div class="col-md-6 small_screen_margin_top">
                    <div class="form-group">
                      <label>Datum prijave</label><i class="arrow-down"></i>
                      <input type="text" placeholder="Datum dolaska" id="date_check_in">
                    </div>
                  </div>
                  <div class="col-md-6 small_screen_margin_top">
                    <div class="form-group">
                      <label>Datum odjave</label><i class="arrow-down"></i>
                      <input type="text" placeholder="Datum odlaska" id="date_check_out">
                    </div>
                  </div>
      ...
      <section class="light_section">
        <div class="container">
          <div class="col-md-12 text-center">
            <div class="section_header overlay"><span>DOBRODOŠLI</span>
              <h1>HOTEL VIDOVIĆ</h1>
              <p>JEDNO OD NAJBOLJIH MESTA ZA POSETU</p><img src="assets/images/decoration-1.png" alt="Image">
            </div>
          </div>
          <div class="col-md-10 col-md-offset-1 text-center margin_bottom">
            <div class="text_block">
              <h3>Izjava direktora</h3>
              <p>Nikada ne oklevamo u našoj podršci i nikada ne gubimo iz vida našu glavnu misiju: služenje našim
          ...
          <div class="col-md-4 negative_margin_bottom small_screen_margin_top">
            <div class="entry"><a href="#"><img src="assets/images/recepcijaresize.png" alt="Image">
          ...
          <div class="col-md-4 negative_margin_bottom small_screen_margin_top">
            <div class="entry"><a href="#"><img src="assets/images/restoranresize.png" alt="Image">
          ...
          <div class="col-md-4 negative_margin_bottom small_screen_margin_top">
            <div class="entry"><a href="#"><img src="assets/images/trzniresize.png" alt="Image">
          ...
          <div class="owl-carousel owl-rooms-carousel">
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="col-md-6 small_screen_margin_top">
                  <div class="row"><a href="room-single.html"><img src="assets/images/recepcija.png" alt="Image"></a>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="col-md-6 room_bg_dark full_width_room card-height">
                  <div class="text_block">
                    ...
                    <p class="text-justify">“A la kart” restoran hotela Vidović posjeduje oko 50 mjesta i u ugodnom
                      ...
                      nagrađena savršenim okusom.</p><a href="#" class="btn btn-link">Pročitaj više</a>
                  </div>
                </div>
                <div class="col-md-6 small_screen_margin_top">
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              <div class="section_header elegant">
                <h1>IZJAVE POSETILACA</h1>
                <p>Šta naši klijenti misle o nama.</p><img src="assets/images/decoration-1.png" alt="Image">
              </div>
            </div>
            <div class="col-md-8 col-md-offset-2">
              <div class="col-md-12">
                <div class="testimonial testimonial-slider">
                  <ul class="slides">
                    <li><img src="assets/images/drazen.PNG" alt="Image" class="img-circle">
                      <div class="name"><strong>Dražen</strong> - Švajcarska</div>
                      <div class="experience"><strong>Sveukupno iskustvo</strong> - Odlično</div>
                      <p>"Lijep hotel na odličnoj lokaciji. "</p>
                    </li>
                    <li><img src="assets/images/Aleksandar.png" alt="Image" class="img-circle">
                      <div class="name"><strong>Aleksandar</strong> - Bosna i Hercegovina</div>
                      <div class="experience"><strong>Sveukupno iskustvo</strong> - Odlično</div>
                      <p>" Lijep hotel u centru grada sa garažom unutar hotela. Možete odabrati sobu za pušače ako
                        želite što je za mene velika prednost. Odlična opcija za boravak u Banja Luci za novac. "</p>
                    </li>
                    <li><img src="assets/images/niels.png" alt="Image" class="img-circle">
                      <div class="name"><strong>Niels</strong> - Holandija</div>
                      <div class="experience"><strong>Sveukupno iskustvo</strong> - Vrlo dobro</div>
                      <p>" U samom centru grada. Velika soba i parking mjesto. Ljubazno osoblje i pristojan doručak. "
                      </p>
                    </li>
                    <li><img src="assets/images/frank.png" alt="Image" class="img-circle">
                      <div class="name"><strong>Frank</strong> - Irska</div>
                      <div class="experience"><strong>Sveukupno iskustvo</strong> - Vrlo dobro</div>
                      <p>" Odlična lokacija u centru grada. Soba je veoma prijatna i prostrana. Stil je moderan i visoke
                        obrade. Osoblje profesionalno i ljubazno. "</p>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-6 col-lg-7">
              <div class="row">
                <div style="background-image: url(assets/images/hotel2.png)" class="stretchy_wrapper ratio_16-9"></div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4 col-lg-pull-1">
              <div class="row">
                <div class="banner text_block"><span></span>
                  <h2>Posjetite nas i otkrite sve što Vam možemo ponuditi</h2>
                  <p>Hotel Vidović Vam želi dobrodošlicu i ugodan boravak. Osjećajte se prijatno u najluksuznije
                    opremljenom hotelu koji zaspolaže sa 56 odlično opremljenim sobama sa podzemnom garažom iz koje ste
                    liftom povezani sa sobama.</p><a href="index-activities.html" class="btn btn-black">Pročitaj
                    više</a>
                </div>
              </div>
            </div>
    ...
    <div class="secondary_nav_widgetized_area">
      ...
      <aside class="widget widget_text">
        <h4>ABOUT XENIA</h4>
        <div class="textwidget text-justify"> Either you look for a luxurious experience or a remarkable on the go
          experience, Xenia Resort is the place to visit and spend the time at. We offer quality services.</div>
        <div class="text_block">
